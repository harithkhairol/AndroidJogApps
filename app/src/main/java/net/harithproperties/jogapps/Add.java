...
public class Add extends AppCompatActivity {
    ...
    public void saveData(){
        ...
        if(EditTextEmptyHold == true)
        {
            ...
            values.put(DBHelper.DATE,"a");
            values.put(DBHelper.TIME,"a");
            values.put(DBHelper.DISTANCEKM,"a" );
            values.put(DBHelper.SPEED,"a" );
            values.put(DBHelper.DURATION,"a" );
            ...
            Toast.makeText(Add.this,"Data Inserted Successfully", Toast.LENGTH_LONG).show();

        }
        else {

            Toast.makeText(Add.this,"Please Fill All The Required Fields.", Toast.LENGTH_LONG).show();
